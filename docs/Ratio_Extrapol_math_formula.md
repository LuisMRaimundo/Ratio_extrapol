...
**G. Specialist:** Shared-$L$ Iowa effects are excluded from principal evidence by design. Sul tasto is never invented. This is a research-design rule, not a likelihood.
